---
title: " $args[0].Value.ToUpper() uilder $args[0].Value.ToUpper() oles"
section: "users-and-access"
slug: "builder-roles"
---

#  $args[0].Value.ToUpper() uilder $args[0].Value.ToUpper() oles

> CASTQUEST V3 — users-and-access /  $args[0].Value.ToUpper() uilder $args[0].Value.ToUpper() oles
