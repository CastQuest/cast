---
title: " $args[0].Value.ToUpper() dmin $args[0].Value.ToUpper() oles"
section: "users-and-access"
slug: "admin-roles"
---

#  $args[0].Value.ToUpper() dmin $args[0].Value.ToUpper() oles

> CASTQUEST V3 — users-and-access /  $args[0].Value.ToUpper() dmin $args[0].Value.ToUpper() oles
