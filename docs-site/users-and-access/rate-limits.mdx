---
title: " $args[0].Value.ToUpper() ate $args[0].Value.ToUpper() imits"
section: "users-and-access"
slug: "rate-limits"
---

#  $args[0].Value.ToUpper() ate $args[0].Value.ToUpper() imits

> CASTQUEST V3 — users-and-access /  $args[0].Value.ToUpper() ate $args[0].Value.ToUpper() imits
