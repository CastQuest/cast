---
title: " $args[0].Value.ToUpper() ccess $args[0].Value.ToUpper() ogs"
section: "users-and-access"
slug: "access-logs"
---

#  $args[0].Value.ToUpper() ccess $args[0].Value.ToUpper() ogs

> CASTQUEST V3 — users-and-access /  $args[0].Value.ToUpper() ccess $args[0].Value.ToUpper() ogs
