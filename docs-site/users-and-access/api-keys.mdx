---
title: " $args[0].Value.ToUpper() pi $args[0].Value.ToUpper() eys"
section: "users-and-access"
slug: "api-keys"
---

#  $args[0].Value.ToUpper() pi $args[0].Value.ToUpper() eys

> CASTQUEST V3 — users-and-access /  $args[0].Value.ToUpper() pi $args[0].Value.ToUpper() eys
