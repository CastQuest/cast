---
title: " $args[0].Value.ToUpper() ession $args[0].Value.ToUpper() ecurity"
section: "users-and-access"
slug: "session-security"
---

#  $args[0].Value.ToUpper() ession $args[0].Value.ToUpper() ecurity

> CASTQUEST V3 — users-and-access /  $args[0].Value.ToUpper() ession $args[0].Value.ToUpper() ecurity
