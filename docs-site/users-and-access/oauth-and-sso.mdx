---
title: " $args[0].Value.ToUpper() auth $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() so"
section: "users-and-access"
slug: "oauth-and-sso"
---

#  $args[0].Value.ToUpper() auth $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() so

> CASTQUEST V3 — users-and-access /  $args[0].Value.ToUpper() auth $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() so
