---
title: " $args[0].Value.ToUpper() as $args[0].Value.ToUpper() odel"
section: "l3"
slug: "gas-model"
---

#  $args[0].Value.ToUpper() as $args[0].Value.ToUpper() odel

> CASTQUEST V3 — l3 /  $args[0].Value.ToUpper() as $args[0].Value.ToUpper() odel
