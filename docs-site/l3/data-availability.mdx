---
title: " $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() vailability"
section: "l3"
slug: "data-availability"
---

#  $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() vailability

> CASTQUEST V3 — l3 /  $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() vailability
