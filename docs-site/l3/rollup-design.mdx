---
title: " $args[0].Value.ToUpper() ollup $args[0].Value.ToUpper() esign"
section: "l3"
slug: "rollup-design"
---

#  $args[0].Value.ToUpper() ollup $args[0].Value.ToUpper() esign

> CASTQUEST V3 — l3 /  $args[0].Value.ToUpper() ollup $args[0].Value.ToUpper() esign
