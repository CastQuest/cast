---
title: " $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() oops"
section: "tokens"
slug: "buyback-loops"
---

#  $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() oops

> CASTQUEST V3 — tokens /  $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() oops
