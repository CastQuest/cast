---
title: " $args[0].Value.ToUpper() ricing $args[0].Value.ToUpper() racles"
section: "tokens"
slug: "pricing-oracles"
---

#  $args[0].Value.ToUpper() ricing $args[0].Value.ToUpper() racles

> CASTQUEST V3 — tokens /  $args[0].Value.ToUpper() ricing $args[0].Value.ToUpper() racles
