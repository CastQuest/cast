---
title: " $args[0].Value.ToUpper() ast $args[0].Value.ToUpper() oken"
section: "tokens"
slug: "cast-token"
---

#  $args[0].Value.ToUpper() ast $args[0].Value.ToUpper() oken

> CASTQUEST V3 — tokens /  $args[0].Value.ToUpper() ast $args[0].Value.ToUpper() oken
