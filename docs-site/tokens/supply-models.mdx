---
title: " $args[0].Value.ToUpper() upply $args[0].Value.ToUpper() odels"
section: "tokens"
slug: "supply-models"
---

#  $args[0].Value.ToUpper() upply $args[0].Value.ToUpper() odels

> CASTQUEST V3 — tokens /  $args[0].Value.ToUpper() upply $args[0].Value.ToUpper() odels
