---
title: " $args[0].Value.ToUpper() rofile $args[0].Value.ToUpper() okens"
section: "tokens"
slug: "profile-tokens"
---

#  $args[0].Value.ToUpper() rofile $args[0].Value.ToUpper() okens

> CASTQUEST V3 — tokens /  $args[0].Value.ToUpper() rofile $args[0].Value.ToUpper() okens
