---
title: " $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() okens"
section: "tokens"
slug: "fee-tokens"
---

#  $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() okens

> CASTQUEST V3 — tokens /  $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() okens
