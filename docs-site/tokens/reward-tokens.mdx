---
title: " $args[0].Value.ToUpper() eward $args[0].Value.ToUpper() okens"
section: "tokens"
slug: "reward-tokens"
---

#  $args[0].Value.ToUpper() eward $args[0].Value.ToUpper() okens

> CASTQUEST V3 — tokens /  $args[0].Value.ToUpper() eward $args[0].Value.ToUpper() okens
