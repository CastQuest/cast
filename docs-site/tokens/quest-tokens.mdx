---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() okens"
section: "tokens"
slug: "quest-tokens"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() okens

> CASTQUEST V3 — tokens /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() okens
