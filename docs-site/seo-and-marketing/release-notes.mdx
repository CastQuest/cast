---
title: " $args[0].Value.ToUpper() elease $args[0].Value.ToUpper() otes"
section: "seo-and-marketing"
slug: "release-notes"
---

#  $args[0].Value.ToUpper() elease $args[0].Value.ToUpper() otes

> CASTQUEST V3 — seo-and-marketing /  $args[0].Value.ToUpper() elease $args[0].Value.ToUpper() otes
