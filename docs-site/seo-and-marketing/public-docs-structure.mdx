---
title: " $args[0].Value.ToUpper() ublic $args[0].Value.ToUpper() ocs $args[0].Value.ToUpper() tructure"
section: "seo-and-marketing"
slug: "public-docs-structure"
---

#  $args[0].Value.ToUpper() ublic $args[0].Value.ToUpper() ocs $args[0].Value.ToUpper() tructure
