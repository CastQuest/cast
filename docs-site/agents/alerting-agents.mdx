---
title: " $args[0].Value.ToUpper() lerting $args[0].Value.ToUpper() gents"
section: "agents"
slug: "alerting-agents"
---

#  $args[0].Value.ToUpper() lerting $args[0].Value.ToUpper() gents

> CASTQUEST V3 — agents /  $args[0].Value.ToUpper() lerting $args[0].Value.ToUpper() gents
