---
title: " $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() gents"
section: "agents"
slug: "governance-agents"
---

#  $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() gents

> CASTQUEST V3 — agents /  $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() gents
