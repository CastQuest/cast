...
For production without containers:
...
kubectl apply -f infra/k8s/production/agents-deployment-green.yaml

# Test green deployment
curl http://agents-green.internal/health

# Switch traffic to green
kubectl patch service agents -p '{"spec":{"selector":{"version":"green"}}}'

# Remove blue deployment
kubectl delete -f infra/k8s/production/agents-deployment-blue.yaml
```
