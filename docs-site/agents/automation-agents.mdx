---
title: " $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() gents"
section: "agents"
slug: "automation-agents"
---

#  $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() gents

> CASTQUEST V3 — agents /  $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() gents
