---
title: " $args[0].Value.ToUpper() rain $args[0].Value.ToUpper() ngine $args[0].Value.ToUpper() gents"
section: "agents"
slug: "brain-engine-agents"
---

#  $args[0].Value.ToUpper() rain $args[0].Value.ToUpper() ngine $args[0].Value.ToUpper() gents

> CASTQUEST V3 — agents /  $args[0].Value.ToUpper() rain $args[0].Value.ToUpper() ngine $args[0].Value.ToUpper() gents
