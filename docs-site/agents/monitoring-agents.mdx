---
title: " $args[0].Value.ToUpper() onitoring $args[0].Value.ToUpper() gents"
section: "agents"
slug: "monitoring-agents"
---

#  $args[0].Value.ToUpper() onitoring $args[0].Value.ToUpper() gents

> CASTQUEST V3 — agents /  $args[0].Value.ToUpper() onitoring $args[0].Value.ToUpper() gents
