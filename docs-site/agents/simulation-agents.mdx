---
title: " $args[0].Value.ToUpper() imulation $args[0].Value.ToUpper() gents"
section: "agents"
slug: "simulation-agents"
---

#  $args[0].Value.ToUpper() imulation $args[0].Value.ToUpper() gents

> CASTQUEST V3 — agents /  $args[0].Value.ToUpper() imulation $args[0].Value.ToUpper() gents
