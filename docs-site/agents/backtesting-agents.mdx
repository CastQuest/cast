---
title: " $args[0].Value.ToUpper() acktesting $args[0].Value.ToUpper() gents"
section: "agents"
slug: "backtesting-agents"
---

#  $args[0].Value.ToUpper() acktesting $args[0].Value.ToUpper() gents

> CASTQUEST V3 — agents /  $args[0].Value.ToUpper() acktesting $args[0].Value.ToUpper() gents
