---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() gents"
section: "agents"
slug: "worker-agents"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() gents

> CASTQUEST V3 — agents /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() gents
