---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() utomation"
section: "mints"
slug: "mint-automation"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() utomation

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() utomation
