---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ifecycle"
section: "mints"
slug: "mint-lifecycle"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ifecycle

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ifecycle
