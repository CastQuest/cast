---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ecovery"
section: "mints"
slug: "mint-recovery"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ecovery

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ecovery
