---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ailures"
section: "mints"
slug: "mint-failures"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ailures

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ailures
