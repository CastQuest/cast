---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() emplates"
section: "mints"
slug: "mint-templates"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() emplates

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() emplates
