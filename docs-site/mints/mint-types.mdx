---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ypes"
section: "mints"
slug: "mint-types"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ypes

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ypes
