---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() imits"
section: "mints"
slug: "mint-limits"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() imits

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() imits
