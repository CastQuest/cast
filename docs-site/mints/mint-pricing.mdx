---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ricing"
section: "mints"
slug: "mint-pricing"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ricing

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ricing
