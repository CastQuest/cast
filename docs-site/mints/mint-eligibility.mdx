---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ligibility"
section: "mints"
slug: "mint-eligibility"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ligibility

> CASTQUEST V3 — mints /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() ligibility
