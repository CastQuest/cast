---
title: " $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() chemas"
section: "reference"
slug: "data-schemas"
---

#  $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() chemas

> CASTQUEST V3 — reference /  $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() chemas
