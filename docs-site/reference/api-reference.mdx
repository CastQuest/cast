---
title: " $args[0].Value.ToUpper() pi $args[0].Value.ToUpper() eference"
section: "reference"
slug: "api-reference"
---

#  $args[0].Value.ToUpper() pi $args[0].Value.ToUpper() eference

> CASTQUEST V3 — reference /  $args[0].Value.ToUpper() pi $args[0].Value.ToUpper() eference
