---
title: " $args[0].Value.ToUpper() eprecation $args[0].Value.ToUpper() olicy"
section: "reference"
slug: "deprecation-policy"
---

#  $args[0].Value.ToUpper() eprecation $args[0].Value.ToUpper() olicy

> CASTQUEST V3 — reference /  $args[0].Value.ToUpper() eprecation $args[0].Value.ToUpper() olicy
