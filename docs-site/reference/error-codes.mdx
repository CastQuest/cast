---
title: " $args[0].Value.ToUpper() rror $args[0].Value.ToUpper() odes"
section: "reference"
slug: "error-codes"
---

#  $args[0].Value.ToUpper() rror $args[0].Value.ToUpper() odes

> CASTQUEST V3 — reference /  $args[0].Value.ToUpper() rror $args[0].Value.ToUpper() odes
