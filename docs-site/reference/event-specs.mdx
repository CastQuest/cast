---
title: " $args[0].Value.ToUpper() vent $args[0].Value.ToUpper() pecs"
section: "reference"
slug: "event-specs"
---

#  $args[0].Value.ToUpper() vent $args[0].Value.ToUpper() pecs

> CASTQUEST V3 — reference /  $args[0].Value.ToUpper() vent $args[0].Value.ToUpper() pecs
