---
title: " $args[0].Value.ToUpper() ystem $args[0].Value.ToUpper() tatus"
section: "admin-dashboard"
slug: "system-status"
---

#  $args[0].Value.ToUpper() ystem $args[0].Value.ToUpper() tatus

> CASTQUEST V3 — admin-dashboard /  $args[0].Value.ToUpper() ystem $args[0].Value.ToUpper() tatus
