---
title: " $args[0].Value.ToUpper() udit $args[0].Value.ToUpper() ogs"
section: "admin-dashboard"
slug: "audit-logs"
---

#  $args[0].Value.ToUpper() udit $args[0].Value.ToUpper() ogs

> CASTQUEST V3 — admin-dashboard /  $args[0].Value.ToUpper() udit $args[0].Value.ToUpper() ogs
