---
title: " $args[0].Value.ToUpper() rotocol $args[0].Value.ToUpper() ees"
section: "admin-dashboard"
slug: "protocol-fees"
---

#  $args[0].Value.ToUpper() rotocol $args[0].Value.ToUpper() ees

> CASTQUEST V3 — admin-dashboard /  $args[0].Value.ToUpper() rotocol $args[0].Value.ToUpper() ees
