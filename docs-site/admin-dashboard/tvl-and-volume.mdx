---
title: " $args[0].Value.ToUpper() vl $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() olume"
section: "admin-dashboard"
slug: "tvl-and-volume"
---

#  $args[0].Value.ToUpper() vl $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() olume
