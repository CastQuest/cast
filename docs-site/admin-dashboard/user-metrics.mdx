---
title: " $args[0].Value.ToUpper() ser $args[0].Value.ToUpper() etrics"
section: "admin-dashboard"
slug: "user-metrics"
---

#  $args[0].Value.ToUpper() ser $args[0].Value.ToUpper() etrics

> CASTQUEST V3 — admin-dashboard /  $args[0].Value.ToUpper() ser $args[0].Value.ToUpper() etrics
