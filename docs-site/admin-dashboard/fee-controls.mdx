---
title: " $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() ontrols"
section: "admin-dashboard"
slug: "fee-controls"
---

#  $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() ontrols

> CASTQUEST V3 — admin-dashboard /  $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() ontrols
