---
title: " $args[0].Value.ToUpper() oken $args[0].Value.ToUpper() anagement"
section: "admin-dashboard"
slug: "token-management"
---

#  $args[0].Value.ToUpper() oken $args[0].Value.ToUpper() anagement

> CASTQUEST V3 — admin-dashboard /  $args[0].Value.ToUpper() oken $args[0].Value.ToUpper() anagement
