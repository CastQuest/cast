---
title: " $args[0].Value.ToUpper() verview $args[0].Value.ToUpper() etrics"
section: "admin-dashboard"
slug: "overview-metrics"
---

#  $args[0].Value.ToUpper() verview $args[0].Value.ToUpper() etrics

> CASTQUEST V3 — admin-dashboard /  $args[0].Value.ToUpper() verview $args[0].Value.ToUpper() etrics
