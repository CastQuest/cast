---
title: " $args[0].Value.ToUpper() ause $args[0].Value.ToUpper() rotocol"
section: "admin-dashboard"
slug: "pause-protocol"
---

#  $args[0].Value.ToUpper() ause $args[0].Value.ToUpper() rotocol

> CASTQUEST V3 — admin-dashboard /  $args[0].Value.ToUpper() ause $args[0].Value.ToUpper() rotocol
