---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() emplates"
section: "quests"
slug: "quest-templates"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() emplates

> CASTQUEST V3 — quests /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() emplates
