---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ailures"
section: "quests"
slug: "quest-failures"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ailures

> CASTQUEST V3 — quests /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ailures
