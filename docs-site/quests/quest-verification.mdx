---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() erification"
section: "quests"
slug: "quest-verification"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() erification

> CASTQUEST V3 — quests /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() erification
