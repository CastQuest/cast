---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() utomation"
section: "quests"
slug: "quest-automation"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() utomation

> CASTQUEST V3 — quests /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() utomation
