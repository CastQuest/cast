---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() buse $args[0].Value.ToUpper() revention"
section: "quests"
slug: "quest-abuse-prevention"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() buse $args[0].Value.ToUpper() revention

> CASTQUEST V3 — quests /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() buse $args[0].Value.ToUpper() revention
