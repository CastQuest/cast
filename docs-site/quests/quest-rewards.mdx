---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ewards"
section: "quests"
slug: "quest-rewards"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ewards

> CASTQUEST V3 — quests /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ewards
