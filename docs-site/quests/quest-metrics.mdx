---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() etrics"
section: "quests"
slug: "quest-metrics"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() etrics

> CASTQUEST V3 — quests /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() etrics
