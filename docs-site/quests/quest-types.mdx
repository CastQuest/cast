---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ypes"
section: "quests"
slug: "quest-types"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ypes

> CASTQUEST V3 — quests /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() ypes
