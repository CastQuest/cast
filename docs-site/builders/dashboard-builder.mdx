---
title: " $args[0].Value.ToUpper() ashboard $args[0].Value.ToUpper() uilder"
section: "builders"
slug: "dashboard-builder"
---

#  $args[0].Value.ToUpper() ashboard $args[0].Value.ToUpper() uilder

> CASTQUEST V3 — builders /  $args[0].Value.ToUpper() ashboard $args[0].Value.ToUpper() uilder
