---
title: " $args[0].Value.ToUpper() int $args[0].Value.ToUpper() uilder"
section: "builders"
slug: "mint-builder"
---

#  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() uilder

> CASTQUEST V3 — builders /  $args[0].Value.ToUpper() int $args[0].Value.ToUpper() uilder
