---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() uilder"
section: "builders"
slug: "frame-builder"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() uilder

> CASTQUEST V3 — builders /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() uilder
