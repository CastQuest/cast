---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() uilder"
section: "builders"
slug: "worker-builder"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() uilder

> CASTQUEST V3 — builders /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() uilder
