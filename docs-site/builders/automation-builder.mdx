---
title: " $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() uilder"
section: "builders"
slug: "automation-builder"
---

#  $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() uilder

> CASTQUEST V3 — builders /  $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() uilder
