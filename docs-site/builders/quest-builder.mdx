---
title: " $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() uilder"
section: "builders"
slug: "quest-builder"
---

#  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() uilder

> CASTQUEST V3 — builders /  $args[0].Value.ToUpper() uest $args[0].Value.ToUpper() uilder
