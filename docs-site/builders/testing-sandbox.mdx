---
title: " $args[0].Value.ToUpper() esting $args[0].Value.ToUpper() andbox"
section: "builders"
slug: "testing-sandbox"
---

#  $args[0].Value.ToUpper() esting $args[0].Value.ToUpper() andbox

> CASTQUEST V3 — builders /  $args[0].Value.ToUpper() esting $args[0].Value.ToUpper() andbox
