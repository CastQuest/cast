---
title: " $args[0].Value.ToUpper() ecurity $args[0].Value.ToUpper() odel"
section: "overview"
slug: "security-model"
---

#  $args[0].Value.ToUpper() ecurity $args[0].Value.ToUpper() odel

> CASTQUEST V3 — overview /  $args[0].Value.ToUpper() ecurity $args[0].Value.ToUpper() odel
