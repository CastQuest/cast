---
title: " $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() odel"
section: "overview"
slug: "data-model"
---

#  $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() odel

> CASTQUEST V3 — overview /  $args[0].Value.ToUpper() ata $args[0].Value.ToUpper() odel
