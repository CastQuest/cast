---
title: " $args[0].Value.ToUpper() ulti $args[0].Value.ToUpper() hain $args[0].Value.ToUpper() rchitecture"
section: "overview"
slug: "multi-chain-architecture"
---

#  $args[0].Value.ToUpper() ulti $args[0].Value.ToUpper() hain $args[0].Value.ToUpper() rchitecture

> CASTQUEST V3 — overview /  $args[0].Value.ToUpper() ulti $args[0].Value.ToUpper() hain $args[0].Value.ToUpper() rchitecture
