---
title: " $args[0].Value.ToUpper() ircuit $args[0].Value.ToUpper() reakers"
section: "risk-and-compliance"
slug: "circuit-breakers"
---

#  $args[0].Value.ToUpper() ircuit $args[0].Value.ToUpper() reakers

> CASTQUEST V3 — risk-and-compliance /  $args[0].Value.ToUpper() ircuit $args[0].Value.ToUpper() reakers
