---
title: " $args[0].Value.ToUpper() yc $args[0].Value.ToUpper() ml $args[0].Value.ToUpper() ntegration"
section: "risk-and-compliance"
slug: "kyc-aml-integration"
---

#  $args[0].Value.ToUpper() yc $args[0].Value.ToUpper() ml $args[0].Value.ToUpper() ntegration

> CASTQUEST V3 — risk-and-compliance /  $args[0].Value.ToUpper() yc $args[0].Value.ToUpper() ml $args[0].Value.ToUpper() ntegration
