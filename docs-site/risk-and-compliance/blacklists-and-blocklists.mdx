---
title: " $args[0].Value.ToUpper() lacklists $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() locklists"
section: "risk-and-compliance"
slug: "blacklists-and-blocklists"
---

#  $args[0].Value.ToUpper() lacklists $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() locklists

> CASTQUEST V3 — risk-and-compliance /  $args[0].Value.ToUpper() lacklists $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() locklists
