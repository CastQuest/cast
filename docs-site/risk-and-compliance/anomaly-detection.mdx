---
title: " $args[0].Value.ToUpper() nomaly $args[0].Value.ToUpper() etection"
section: "risk-and-compliance"
slug: "anomaly-detection"
---

#  $args[0].Value.ToUpper() nomaly $args[0].Value.ToUpper() etection

> CASTQUEST V3 — risk-and-compliance /  $args[0].Value.ToUpper() nomaly $args[0].Value.ToUpper() etection
