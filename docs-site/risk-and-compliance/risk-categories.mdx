---
title: " $args[0].Value.ToUpper() isk $args[0].Value.ToUpper() ategories"
section: "risk-and-compliance"
slug: "risk-categories"
---

#  $args[0].Value.ToUpper() isk $args[0].Value.ToUpper() ategories

> CASTQUEST V3 — risk-and-compliance /  $args[0].Value.ToUpper() isk $args[0].Value.ToUpper() ategories
