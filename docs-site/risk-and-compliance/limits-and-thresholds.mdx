---
title: " $args[0].Value.ToUpper() imits $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() hresholds"
section: "risk-and-compliance"
slug: "limits-and-thresholds"
---

#  $args[0].Value.ToUpper() imits $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() hresholds

> CASTQUEST V3 — risk-and-compliance /  $args[0].Value.ToUpper() imits $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() hresholds
