---
title: " $args[0].Value.ToUpper() ixed $args[0].Value.ToUpper() rice"
section: "marketplace"
slug: "fixed-price"
---

#  $args[0].Value.ToUpper() ixed $args[0].Value.ToUpper() rice

> CASTQUEST V3 — marketplace /  $args[0].Value.ToUpper() ixed $args[0].Value.ToUpper() rice
