---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() estarts"
section: "workers"
slug: "worker-restarts"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() estarts

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() estarts
