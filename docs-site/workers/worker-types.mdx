---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ypes"
section: "workers"
slug: "worker-types"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ypes

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ypes
