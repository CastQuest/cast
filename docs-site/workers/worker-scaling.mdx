---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() caling"
section: "workers"
slug: "worker-scaling"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() caling

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() caling
