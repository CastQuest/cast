---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() afety"
section: "workers"
slug: "worker-safety"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() afety

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() afety
