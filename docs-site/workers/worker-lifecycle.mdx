---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ifecycle"
section: "workers"
slug: "worker-lifecycle"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ifecycle

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ifecycle
