---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ermissions"
section: "workers"
slug: "worker-permissions"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ermissions

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ermissions
