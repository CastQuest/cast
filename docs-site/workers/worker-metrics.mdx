---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() etrics"
section: "workers"
slug: "worker-metrics"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() etrics

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() etrics
