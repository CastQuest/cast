---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ailures"
section: "workers"
slug: "worker-failures"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ailures

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() ailures
