---
title: " $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() andbox"
section: "workers"
slug: "worker-sandbox"
---

#  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() andbox

> CASTQUEST V3 — workers /  $args[0].Value.ToUpper() orker $args[0].Value.ToUpper() andbox
