---
title: " $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() ooks"
section: "brain-engine"
slug: "governance-hooks"
---

#  $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() ooks

> CASTQUEST V3 — brain-engine /  $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() ooks
