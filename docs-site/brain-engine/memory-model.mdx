---
title: " $args[0].Value.ToUpper() emory $args[0].Value.ToUpper() odel"
section: "brain-engine"
slug: "memory-model"
---

#  $args[0].Value.ToUpper() emory $args[0].Value.ToUpper() odel

> CASTQUEST V3 — brain-engine /  $args[0].Value.ToUpper() emory $args[0].Value.ToUpper() odel
