---
title: " $args[0].Value.ToUpper() afety $args[0].Value.ToUpper() ails"
section: "brain-engine"
slug: "safety-rails"
---

#  $args[0].Value.ToUpper() afety $args[0].Value.ToUpper() ails

> CASTQUEST V3 — brain-engine /  $args[0].Value.ToUpper() afety $args[0].Value.ToUpper() ails
