---
title: " $args[0].Value.ToUpper() rain $args[0].Value.ToUpper() ngine"
section: "brain-engine"
slug: "index"
---

#  $args[0].Value.ToUpper() rain $args[0].Value.ToUpper() ngine

> CASTQUEST V3 — brain-engine /  $args[0].Value.ToUpper() rain $args[0].Value.ToUpper() ngine
