---
title: " $args[0].Value.ToUpper() ntegration $args[0].Value.ToUpper() ith $args[0].Value.ToUpper() orkers"
section: "brain-engine"
slug: "integration-with-workers"
---

#  $args[0].Value.ToUpper() ntegration $args[0].Value.ToUpper() ith $args[0].Value.ToUpper() orkers

> CASTQUEST V3 — brain-engine /  $args[0].Value.ToUpper() ntegration $args[0].Value.ToUpper() ith $args[0].Value.ToUpper() orkers
