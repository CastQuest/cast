---
title: " $args[0].Value.ToUpper() ntegration $args[0].Value.ToUpper() ith $args[0].Value.ToUpper() rames"
section: "brain-engine"
slug: "integration-with-frames"
---

#  $args[0].Value.ToUpper() ntegration $args[0].Value.ToUpper() ith $args[0].Value.ToUpper() rames

> CASTQUEST V3 — brain-engine /  $args[0].Value.ToUpper() ntegration $args[0].Value.ToUpper() ith $args[0].Value.ToUpper() rames
