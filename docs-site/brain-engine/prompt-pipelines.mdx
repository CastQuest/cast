---
title: " $args[0].Value.ToUpper() rompt $args[0].Value.ToUpper() ipelines"
section: "brain-engine"
slug: "prompt-pipelines"
---

#  $args[0].Value.ToUpper() rompt $args[0].Value.ToUpper() ipelines

> CASTQUEST V3 — brain-engine /  $args[0].Value.ToUpper() rompt $args[0].Value.ToUpper() ipelines
