---
title: " $args[0].Value.ToUpper() artner $args[0].Value.ToUpper() rotocols"
section: "integrations"
slug: "partner-protocols"
---

#  $args[0].Value.ToUpper() artner $args[0].Value.ToUpper() rotocols

> CASTQUEST V3 — integrations /  $args[0].Value.ToUpper() artner $args[0].Value.ToUpper() rotocols
