---
title: " $args[0].Value.ToUpper() otification $args[0].Value.ToUpper() ystems"
section: "integrations"
slug: "notification-systems"
---

#  $args[0].Value.ToUpper() otification $args[0].Value.ToUpper() ystems

> CASTQUEST V3 — integrations /  $args[0].Value.ToUpper() otification $args[0].Value.ToUpper() ystems
