---
title: " $args[0].Value.ToUpper() xternal $args[0].Value.ToUpper() racles"
section: "integrations"
slug: "external-oracles"
---

#  $args[0].Value.ToUpper() xternal $args[0].Value.ToUpper() racles

> CASTQUEST V3 — integrations /  $args[0].Value.ToUpper() xternal $args[0].Value.ToUpper() racles
