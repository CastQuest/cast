---
title: " $args[0].Value.ToUpper() isk $args[0].Value.ToUpper() ngine"
section: "protocol"
slug: "risk-engine"
---

#  $args[0].Value.ToUpper() isk $args[0].Value.ToUpper() ngine

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() isk $args[0].Value.ToUpper() ngine
