---
title: " $args[0].Value.ToUpper() pgrade $args[0].Value.ToUpper() trategy"
section: "protocol"
slug: "upgrade-strategy"
---

#  $args[0].Value.ToUpper() pgrade $args[0].Value.ToUpper() trategy

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() pgrade $args[0].Value.ToUpper() trategy
