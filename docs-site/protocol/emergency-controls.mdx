---
title: " $args[0].Value.ToUpper() mergency $args[0].Value.ToUpper() ontrols"
section: "protocol"
slug: "emergency-controls"
---

#  $args[0].Value.ToUpper() mergency $args[0].Value.ToUpper() ontrols

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() mergency $args[0].Value.ToUpper() ontrols
