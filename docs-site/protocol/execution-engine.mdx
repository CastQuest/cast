---
title: " $args[0].Value.ToUpper() xecution $args[0].Value.ToUpper() ngine"
section: "protocol"
slug: "execution-engine"
---

#  $args[0].Value.ToUpper() xecution $args[0].Value.ToUpper() ngine

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() xecution $args[0].Value.ToUpper() ngine
