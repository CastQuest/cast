---
title: " $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() ngine"
section: "protocol"
slug: "governance-engine"
---

#  $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() ngine

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() overnance $args[0].Value.ToUpper() ngine
