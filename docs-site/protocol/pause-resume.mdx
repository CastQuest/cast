---
title: " $args[0].Value.ToUpper() ause $args[0].Value.ToUpper() esume"
section: "protocol"
slug: "pause-resume"
---

#  $args[0].Value.ToUpper() ause $args[0].Value.ToUpper() esume

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() ause $args[0].Value.ToUpper() esume
