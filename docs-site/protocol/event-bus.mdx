---
title: " $args[0].Value.ToUpper() vent $args[0].Value.ToUpper() us"
section: "protocol"
slug: "event-bus"
---

#  $args[0].Value.ToUpper() vent $args[0].Value.ToUpper() us

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() vent $args[0].Value.ToUpper() us
