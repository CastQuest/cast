---
title: " $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() ngine"
section: "protocol"
slug: "buyback-engine"
---

#  $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() ngine

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() ngine
