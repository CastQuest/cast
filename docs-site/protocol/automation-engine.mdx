---
title: " $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() ngine"
section: "protocol"
slug: "automation-engine"
---

#  $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() ngine

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() utomation $args[0].Value.ToUpper() ngine
