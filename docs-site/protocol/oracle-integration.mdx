---
title: " $args[0].Value.ToUpper() racle $args[0].Value.ToUpper() ntegration"
section: "protocol"
slug: "oracle-integration"
---

#  $args[0].Value.ToUpper() racle $args[0].Value.ToUpper() ntegration

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() racle $args[0].Value.ToUpper() ntegration
