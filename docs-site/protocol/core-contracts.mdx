---
title: " $args[0].Value.ToUpper() ore $args[0].Value.ToUpper() ontracts"
section: "protocol"
slug: "core-contracts"
---

#  $args[0].Value.ToUpper() ore $args[0].Value.ToUpper() ontracts

> CASTQUEST V3 — protocol /  $args[0].Value.ToUpper() ore $args[0].Value.ToUpper() ontracts
