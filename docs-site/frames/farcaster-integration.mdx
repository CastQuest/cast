---
title: " $args[0].Value.ToUpper() arcaster $args[0].Value.ToUpper() ntegration"
section: "frames"
slug: "farcaster-integration"
---

#  $args[0].Value.ToUpper() arcaster $args[0].Value.ToUpper() ntegration

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() arcaster $args[0].Value.ToUpper() ntegration
