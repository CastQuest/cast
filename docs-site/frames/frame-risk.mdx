---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() isk"
section: "frames"
slug: "frame-risk"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() isk

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() isk
