---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() mports"
section: "frames"
slug: "frame-imports"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() mports

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() mports
