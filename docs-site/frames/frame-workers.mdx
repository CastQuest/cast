---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() orkers"
section: "frames"
slug: "frame-workers"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() orkers

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() orkers
