---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ints"
section: "frames"
slug: "frame-mints"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ints

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ints
