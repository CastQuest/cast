---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() emplates"
section: "frames"
slug: "frame-templates"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() emplates

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() emplates
