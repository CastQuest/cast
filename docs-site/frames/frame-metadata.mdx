---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() etadata"
section: "frames"
slug: "frame-metadata"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() etadata

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() etadata
