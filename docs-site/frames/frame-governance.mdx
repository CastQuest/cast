---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() overnance"
section: "frames"
slug: "frame-governance"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() overnance

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() overnance
