---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ypes"
section: "frames"
slug: "frame-types"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ypes

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ypes
