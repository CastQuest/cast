---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ifecycle"
section: "frames"
slug: "frame-lifecycle"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ifecycle

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ifecycle
