---
title: " $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ctions"
section: "frames"
slug: "frame-actions"
---

#  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ctions

> CASTQUEST V3 — frames /  $args[0].Value.ToUpper() rame $args[0].Value.ToUpper() ctions
