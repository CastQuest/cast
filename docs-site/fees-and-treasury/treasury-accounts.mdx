---
title: " $args[0].Value.ToUpper() reasury $args[0].Value.ToUpper() ccounts"
section: "fees-and-treasury"
slug: "treasury-accounts"
---

#  $args[0].Value.ToUpper() reasury $args[0].Value.ToUpper() ccounts

> CASTQUEST V3 — fees-and-treasury /  $args[0].Value.ToUpper() reasury $args[0].Value.ToUpper() ccounts
