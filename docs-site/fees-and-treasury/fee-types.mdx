---
title: " $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() ypes"
section: "fees-and-treasury"
slug: "fee-types"
---

#  $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() ypes

> CASTQUEST V3 — fees-and-treasury /  $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() ypes
