---
title: " $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() outing"
section: "fees-and-treasury"
slug: "fee-routing"
---

#  $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() outing

> CASTQUEST V3 — fees-and-treasury /  $args[0].Value.ToUpper() ee $args[0].Value.ToUpper() outing
