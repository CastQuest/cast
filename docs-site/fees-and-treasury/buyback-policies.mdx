---
title: " $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() olicies"
section: "fees-and-treasury"
slug: "buyback-policies"
---

#  $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() olicies

> CASTQUEST V3 — fees-and-treasury /  $args[0].Value.ToUpper() uyback $args[0].Value.ToUpper() olicies
