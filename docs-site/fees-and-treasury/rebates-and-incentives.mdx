---
title: " $args[0].Value.ToUpper() ebates $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() ncentives"
section: "fees-and-treasury"
slug: "rebates-and-incentives"
---

#  $args[0].Value.ToUpper() ebates $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() ncentives

> CASTQUEST V3 — fees-and-treasury /  $args[0].Value.ToUpper() ebates $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() ncentives
