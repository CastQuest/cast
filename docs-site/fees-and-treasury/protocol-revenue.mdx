---
title: " $args[0].Value.ToUpper() rotocol $args[0].Value.ToUpper() evenue"
section: "fees-and-treasury"
slug: "protocol-revenue"
---

#  $args[0].Value.ToUpper() rotocol $args[0].Value.ToUpper() evenue

> CASTQUEST V3 — fees-and-treasury /  $args[0].Value.ToUpper() rotocol $args[0].Value.ToUpper() evenue
