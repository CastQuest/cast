---
title: " $args[0].Value.ToUpper() ees $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() reasury"
section: "fees-and-treasury"
slug: "index"
---

#  $args[0].Value.ToUpper() ees $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() reasury

> CASTQUEST V3 — fees-and-treasury /  $args[0].Value.ToUpper() ees $args[0].Value.ToUpper() nd $args[0].Value.ToUpper() reasury
