---
title: " $args[0].Value.ToUpper() li $args[0].Value.ToUpper() ools"
section: "sdk"
slug: "cli-tools"
---

#  $args[0].Value.ToUpper() li $args[0].Value.ToUpper() ools

> CASTQUEST V3 — sdk /  $args[0].Value.ToUpper() li $args[0].Value.ToUpper() ools
