---
title: " $args[0].Value.ToUpper() ints $args[0].Value.ToUpper() dk"
section: "sdk"
slug: "mints-sdk"
---

#  $args[0].Value.ToUpper() ints $args[0].Value.ToUpper() dk

> CASTQUEST V3 — sdk /  $args[0].Value.ToUpper() ints $args[0].Value.ToUpper() dk
