---
title: " $args[0].Value.ToUpper() dmin $args[0].Value.ToUpper() dk"
section: "sdk"
slug: "admin-sdk"
---

#  $args[0].Value.ToUpper() dmin $args[0].Value.ToUpper() dk

> CASTQUEST V3 — sdk /  $args[0].Value.ToUpper() dmin $args[0].Value.ToUpper() dk
