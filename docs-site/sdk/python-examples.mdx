---
title: " $args[0].Value.ToUpper() ython $args[0].Value.ToUpper() xamples"
section: "sdk"
slug: "python-examples"
---

#  $args[0].Value.ToUpper() ython $args[0].Value.ToUpper() xamples

> CASTQUEST V3 — sdk /  $args[0].Value.ToUpper() ython $args[0].Value.ToUpper() xamples
