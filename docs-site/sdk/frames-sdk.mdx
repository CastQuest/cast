---
title: " $args[0].Value.ToUpper() rames $args[0].Value.ToUpper() dk"
section: "sdk"
slug: "frames-sdk"
---

#  $args[0].Value.ToUpper() rames $args[0].Value.ToUpper() dk

> CASTQUEST V3 — sdk /  $args[0].Value.ToUpper() rames $args[0].Value.ToUpper() dk
