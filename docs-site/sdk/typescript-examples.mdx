---
title: " $args[0].Value.ToUpper() ypescript $args[0].Value.ToUpper() xamples"
section: "sdk"
slug: "typescript-examples"
---

#  $args[0].Value.ToUpper() ypescript $args[0].Value.ToUpper() xamples

> CASTQUEST V3 — sdk /  $args[0].Value.ToUpper() ypescript $args[0].Value.ToUpper() xamples
