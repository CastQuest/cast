---
title: " $args[0].Value.ToUpper() uests $args[0].Value.ToUpper() dk"
section: "sdk"
slug: "quests-sdk"
---

#  $args[0].Value.ToUpper() uests $args[0].Value.ToUpper() dk

> CASTQUEST V3 — sdk /  $args[0].Value.ToUpper() uests $args[0].Value.ToUpper() dk
