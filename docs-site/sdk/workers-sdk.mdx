---
title: " $args[0].Value.ToUpper() orkers $args[0].Value.ToUpper() dk"
section: "sdk"
slug: "workers-sdk"
---

#  $args[0].Value.ToUpper() orkers $args[0].Value.ToUpper() dk

> CASTQUEST V3 — sdk /  $args[0].Value.ToUpper() orkers $args[0].Value.ToUpper() dk
